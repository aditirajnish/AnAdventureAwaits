...
pygame.display.set_caption('An Adventure Awaits! By Aditi Molly Rajnish')
...
dragonImg = load_image('images/dragon.png', 120, 60)
...
def instructions():
    ...
    while True:
        ...
        instructionsImg = load_image('images/instructions.jpg', displayWidth, displayHeight)
...
def game_intro():
    ...
    while True:
        ...
        mainBackground = load_image('images/bkground.jpg', displayWidth, displayHeight)
...
def prompt1():
    ...
    while True:
        ...
        backGround = load_image('images/prompt1.jpg', displayWidth, displayHeight)
...
def prompt2():
    ...
    while True:
        ...
        backGround = load_image('images/prompt2.jpg', displayWidth, displayHeight)
        gameDisplay.blit(backGround, (0, 0))
...
def prompt3():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt3.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt4():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt4.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt5():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt5.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt6():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt6.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt7():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt7.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt8():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt8.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt9():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt9.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt10_1_map():
    while True:
        ...
        mainBackground = load_image('images/prompt10.1.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt10_2_map():
    while True:
        ...
        mainBackground = load_image('images/prompt10.2.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt11():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt11.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt12():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt12.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt13():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt13.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt14():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt14.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt15():
    while True:
        ...
        mainBackground = load_image('images/prompt15.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt16():
    while True:
        ...
        mainBackground = load_image('images/prompt16.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt17():
    while True:
        ...
        mainBackground = load_image('images/prompt17.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt20():
    while True:
        ...
        mainBackground = load_image('images/prompt20.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt21():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt21.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt22():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt22.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt24():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt24.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt25():
    while True:
        ...
        mainBackground = load_image('images/prompt25.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt26():
    while True:
        ...
        mainBackground = load_image('images/prompt26.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt27():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt27.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt28():
    ...
    while True:
        ...
        background = load_image('images/prompt28.jpg', displayWidth, 720)
        gameDisplay.blit(background, (0, 20))

        staff = load_image('images/staff.jpg', 600, 500)
        rect_staff = staff.get_rect()
        rect_staff.center = (720, 400)
        gameDisplay.blit(staff, rect_staff)

        c_note = load_image('images/quarter_note copy.png', 200, 200)
        note = load_image('images/quarter_note.png', 200, 200)

        red_c_note = load_image('images/quarter_note 2 copy.png', 198, 198)

        red_note = load_image('images/quarter_note 2.png', 198, 198)
...
def prompt30():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt30.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt31a():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt31a.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt31b():
    ...
    while True:
        ...
        mainBackground = load_image('images/prompt31b.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def prompt32():
    ...
    while not gameExit:
        ...
        x = x + x_change
        y = y + y_change
        backGround = load_image('images/dragon_background.jpg', displayWidth, displayHeight)
        gameDisplay.blit(backGround, (0, 0))
...
def prompt33():
    while True:
        ...
        mainBackground = load_image('images/prompt33.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
...
def epilogue():
    ...
    while True:
        ...
        mainBackground = load_image('images/epilogue.jpg', displayWidth, displayHeight)
        gameDisplay.blit(mainBackground, (0, 0))
